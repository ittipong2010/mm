...
if ($dbarr[$objResult["Programe"]] < 1) { 
    ...
    $sql_up = "update member set $Bt = '0' where UserID = '".$_SESSION['UserID']."' ";$dbquery_up = mysql_query($sql_up);
...
$sql_up = "update member set hwid_time = '0' where UserID = '".$_SESSION['UserID']."' ";$dbquery_up = mysql_query($sql_up);
	}
?>
