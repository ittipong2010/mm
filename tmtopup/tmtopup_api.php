...
$_CONFIG['mysql']['dbuser'] = 'u811095077_exp1';

// Password ที่ใช้เชื่อมต่อ MySQL Server
$_CONFIG['mysql']['dbpw'] = '44541230';

// ชื่อฐานข้อมูลที่เราจะเติม Point ให้
$_CONFIG['mysql']['dbname'] = 'u811095077_exp1';
...
define('API_PASSKEY', '1650200165723');
...
if($_SERVER['REMOTE_ADDR'] == '203.146.127.115' && isset($_GET['request']))
{
	...
	if($_GET['request'] != false)
	{
		...
		{
			echo 'ERROR|INCORRECT_USERNAME(' . $request['Ref1'] . ')';
		}
